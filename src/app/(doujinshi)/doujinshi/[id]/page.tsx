...
const DoujinshiDetailPage = () => {
    ...
    const contentItem = allItems.find((item) => item.id === contentId) || popularItems[0]
    ...
    return (
        <DoujinshiLayout >
            <div className="space-y-12.5 py-12.5">
                <DoujinshiDetail item={contentItem} isLiked={likedItems[contentItem.id] || false} onToggleLike={toggleLike} />
                <div
